...
import { eventSubSubscriptionsRepository, userRepository } from "@/repositories"
...
export default async function DashboardPage() {
  ...
  const [user, goalRows, totalRows, recentEvents, subscriptionsRegistered] = await Promise.all([

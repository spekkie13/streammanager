...
export function FeedbackButton() {
  ...
  return (
    <div ref={ref} className="fixed bottom-6 right-6 z-50">
      ...
      <button
        onClick={() => setOpen(o => !o)}
        className="flex items-center gap-2 bg-purple-500 hover:bg-purple-600 text-white text-sm font-medium px-4 py-2.5 rounded-full shadow-lg transition-colors"
      >

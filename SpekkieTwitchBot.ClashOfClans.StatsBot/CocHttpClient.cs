...
public class CocHttpClient
{
    ...
    public CocHttpClient()
    {
        ...
        string baseDir = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "/SpekkieTwitchBot";
        string outputDir = $"{baseDir}/Output/ClashOfClans";

        _ClashToken = File.ReadAllText($"{outputDir}{Path.DirectorySeparatorChar}clash api token.txt");
        #if DEBUG
    ...
    {
        //URL: https://api.clashofclans.com/v1/players/%23QYCCULVY
